...
namespace CM3D2.AddYotogiSlider.Plugin
{
    ...
    public class AddYotogiSlider : UnityInjector.PluginBase
    {
        ...
        private string[] sliderName = { "Hưng Phấn", "Tinh Thần", "Reason", "Nhạy cảm", "Tốc độ", "Ahe Y", "Giá trị", "Trước", "Sau" };
        ...
        private Rect winRatioRect = new Rect(0.75f, .30f, 0.35f, .65f);
        ...
        private string [] faceNameShow={
"Erotic thường 1", "khiêu dâm thường là 2", "khiêu dâm thường là 3", "khiêu dâm xấu hổ 1", "khiêu dâm xấu hổ 2", "khiêu dâm xấu hổ 3",
"Erotic phấn khích 0", "khiêu dâm phấn khích 1", "khiêu dâm phấn khích 2", "khiêu dâm phấn khích 3", "căng thẳng khiêu dâm", "kỳ vọng khiêu dâm",
"Erotic cảm giác tốt 1", "khiêu dâm cảm giác tốt 2", "khiêu dâm đáng yêu 3", "khiêu dâm kiên nhẫn 1", "khiêu dâm kiên nhẫn 2", "khiêu dâm kiên nhẫn 3",
"Erotic ác cảm 1", "khiêu dâm sợ hãi", "khiêu dâm đau 1", "khiêu dâm đau 2", "đau khiêu dâm 3", "Eromeso khóc",
"Erotic đỉnh cao", "kiên nhẫn đau khiêu dâm", "khiêu dâm đau lòng kiên nhẫn 2", "khiêu dâm đau lòng kiên nhẫn 3", "absentmindedness khiêu dâm", "động dục",
"Sau khi xuất tinh thường lệ 1", "thường sau khi xuất tinh 2", "sự hưng phấn xuất tinh sau 1", "xuất tinh phấn khích sau khi 2", "xuất tinh cao trào sau khi 1", "xuất tinh cao trào sau khi 2",
"Liếm tình Erotic", "khiêu dâm liếm tình 2", "khiêu dâm liếm niềm vui", "khiêu dâm liếm niềm vui 2", "khiêu dâm ghê tởm Job", "khiêu dâm công việc bình thường",
"Đóng Job tình cảm", "gần liếm niềm vui", "gần liếm niềm vui 2", "gần ghê tởm Job", "gần gũi công việc bình thường", "nụ hôn",
"Erofera tình cảm", "Erofera niềm vui", "Erofera ghê tởm", "Erofera thường", "khiêu dâm Shitaseme", "khiêu dâm Shitaseme niềm vui",
"Đóng Blow tình cảm", "đóng cửa Blow niềm vui", "Blow ghê tởm kín", "đóng cửa Thổi bình thường", "đường nối", "mở mắt nhắm",
"Bình thường", "tức giận", "nụ cười", "nụ cười", "nỗi buồn 2", "khóc",
"Cái nhìn trống", "Jito mắt", "An", "Thở dài", "mặt đi nằm", "mỉm cười",
"Ngạc nhiên", "Punsuka", "quy định mí mắt", "Mu", "co giật nụ cười", "câu hỏi",
"Grin", "có vấn đề", "tư tưởng bind-off", "một chút tức giận", "cám dỗ", "hờn dỗi",
"Kindness", "ngủ tỉnh táo", "đôi mắt rộng mở với", "đôi mắt mở rộng trong đau đớn", "kéo dài yếu", "mở mắt nhắm",
"Kuchiake", "xấu hổ", "nhút nhát", "la hét nhút nhát", "nháy mắt nhút nhát", "mỉm cười e thẹn",
"Mắt Dancing đầu", "khiêu vũ ngáp", "nhảy ngạc nhiên", "điệu nhảy nụ cười", "Đôi mắt nhảy nhàm chán", "Đôi mắt nhảy ràng buộc",
"Dance nháy mắt", "Dansukisu", "Dansujito mắt", "múa rối đối mặt", "khiêu vũ một cách nghiêm túc", "nhảy nỗi buồn",
"Dance cám dỗ", "má 0 nước mắt 0", "má 0 nước mắt 1", "má 0 nước mắt 2", "má 0 Nước mắt 3", "má 1 giọt nước mắt 0",
"Má 1 Nước mắt 1", "má 1 Nước mắt 2", "má 1 Nước mắt 3", "má 2 nước mắt 0", "má 2 giọt nước mắt 1", "má 2 nước mắt 2",
"Má 2 Nước mắt 3", "má 3 giọt nước mắt 1", "má 3 nước mắt 0", "má 3 Nước mắt 2", "má 3 Nước mắt 3", "thêm nước dãi",
"Má 0 0 nước mắt nước dãi", "má 0 Nước mắt 1 dãi", "má 0 nước mắt 2 dãi", "má 0 nước mắt 3 dãi", "má 1 Tears 0 dãi", "má 1 Nước mắt 1 dãi",
"Má 1 Nước mắt 2 dãi", "má 1 Nước mắt 3 dãi", "má 2 nước mắt 0 dãi", "má 2 Nước mắt 1 dãi", "má 2 nước mắt 2 dãi", "má 2 nước mắt 3 dãi",
"Má 3 nước mắt 0 dãi", "má 3 Nước mắt 1 dãi", "má 3 Nước mắt 2 dãi", "má 3 Nước mắt 3 dãi", "Lỗi", "biến dạng",
};
        ...
        private class YotogiButtonGrid : Element
        {
            ...
            public YotogiButtonGrid(string name, string[] buttonNames, string[] butonShow, EventHandler<ButtonEventArgs> _onClick, int row, bool tabEnabled)
            : base(name, new Rect(Window.AutoLayout, Window.AutoLayout, Window.AutoLayout, 0))
            {
                this.buttonNames = buttonNames;
                this.buttonShow = butonShow;
                ...
                GUI.BeginGroup(outRect);
                {
                    ...
                    if (!tabEnabled || tabSelected == 1)
                    {
                        ...
                        scrollViewVector = GUI.BeginScrollView(scrlRect, scrollViewVector, contentRect, false, true);
                        {
                            ...
                            {
                                onClick(GUI.Button(scrlCur, buttonShow[id]), buttonName);
        ...
        public void Awake()
        {
            ...
            _valueIfNullAnalKupaSlider = 0;
            _valueIfNullKupaSlider = 0;
        ...
        public void OnLevelWasLoaded(int level)
        {
            ...
            //Debug.LogWarning("Init load "+level);

            bInitCompleted = false;
            sceneLevel = level;


            ControlSignal.delegateLeftClick_X_Update -= ClickX;
            ControlSignal.delegateRemoveLeftClick_X -= EndClick;
            ControlSignal.delegateLeftClick_X_Update += ClickX;
            ControlSignal.delegateRemoveLeftClick_X += EndClick;
            ControlSignal.delegateLeftClick_X -= ClickXStart;
            ControlSignal.delegateLeftClick_X += ClickXStart;

            if(sceneLevel==14)
            {
                ControlSignal._isAllowIkumInHScene = false;


                StopCoroutine("initCoroutine");
                StopCoroutine("initCoroutineNormal");
            ...
            {
                ControlSignal._isAllowIkumInHScene = true;

                StopCoroutine("initCoroutineNormal");
                StopCoroutine("initCoroutine");
                StartCoroutine("initCoroutineNormal", TimePerInit);
            }

        }

        float _speedMotion = 100;
        public void Update()
        {
            ...
            if (sceneLevel == 14 && bInitCompleted)
            {
                ...
                //Phần này dùng để tăng tốc độ H
                if (Input.GetKey(KeyCode.Mouse0) && Input.GetKey(KeyCode.Mouse1))
                {
                    if (slider != null && slider.ContainsKey("MotionSpeed"))
                        updateMotionSpeed(_speedMotion = slider["MotionSpeed"].Value += 10*Time.deltaTime);
                ...
                else
                {
                    ...
                    {
                        if (slider != null && slider.ContainsKey("MotionSpeed"))
                            updateMotionSpeed(_speedMotion -=20* Time.deltaTime);
                    }
                }
        ...
        //------ Phần này để điều khiển mấy cái click vào để mở rộng vùng H

        private float _orriganlKupaSkill=0;
        private float _orriganlAnalKupaSkill=0;

        private float _valueIfNullKupaSlider=0;
        private float _valueIfNullAnalKupaSlider = 0;

       private float _reasonNow = -1;
        void ClickX(string _targetClick)
        {
                ...
                case "target_vagina":
                    {
                        ...
                        if (slider !=null&& slider.ContainsKey("Kupa") )//&& slider.ContainsKey("Reason"))
                        {

                            from = slider["Kupa"].Value;
                            _data = Math.Min(150, from + 7 * Time.deltaTime);
                            // cộng thêm cho thanh resaon
                            if (slider.ContainsKey("Reason"))
                            {
                                if (_reasonNow < 0) _reasonNow = slider["Reason"].Value;
                                _reasonNow += Time.deltaTime;
                             //   float var_ = UnityEngine.Mathf.Lerp(slider["Reason"].Value, 300, 5 * Time.deltaTime);
                                updateMaidReason(Math.Min((int)_reasonNow, 100));
                            }
                        ...
                        {
                            _data = Math.Min(150, _valueIfNullKupaSlider += 7 * Time.deltaTime);

                        }


                        updateShapeKeyKupaValue(_data);
                ...
                case "target_hip":
                    {
                        ...
                        if (slider != null && slider.ContainsKey("AnalKupa"))
                        {
                        ...
                        {
                            _data = Math.Min(150, _valueIfNullAnalKupaSlider += 7 * Time.deltaTime);

                        }


                        updateShapeKeyAnalKupaValue(_data);
        ...
        void ClickXStart(string _targetClick)
        {
            if (!bInitCompleted) return;
            _reasonNow = -1;
            switch (_targetClick)
            {
                case "target_vagina":
                    {
                        StopCoroutine("DelayResetKupa");
                        break;
                    }
                case "target_hip":
                    {
                        StopCoroutine("DelayResetAnalKupa");
                        break;
                    }
        ...
        IEnumerator DelayResetKupa()
        {
            if (!bInitCompleted) yield break; 

            yield return new WaitForSeconds(1);
            if (slider != null && slider.ContainsKey("Kupa"))
            {
                float from = slider["Kupa"].Value;
                pa["KUPA.止める"].Play(from, _orriganlKupaSkill);

            }

            else
            {
                while (_valueIfNullKupaSlider > _orriganlKupaSkill)
                {
                    var _data = UnityEngine.Mathf.Clamp(_valueIfNullKupaSlider -= 15 * Time.deltaTime, _orriganlKupaSkill, 150);
        ...
        IEnumerator DelayResetAnalKupa()
        {
            if (!bInitCompleted) yield break;
            ...
            if (slider != null && slider.ContainsKey("AnalKupa"))
            {
                float from = slider["AnalKupa"].Value;
                pa["AKPA.止める"].Play(from, _orriganlAnalKupaSkill);

            }

            else
            {
               // pa["AKPA.止める"].Play(Math.Min(150, _valueIfNullAnalKupaSlider -= 3 * Time.deltaTime), _orriganlAnalKupaSkill);

                while (_valueIfNullAnalKupaSlider > _orriganlAnalKupaSkill)
                {
                  var  _data = UnityEngine.Mathf.Clamp(_valueIfNullAnalKupaSlider -= 15 * Time.deltaTime, _orriganlAnalKupaSkill, 150);
                    yield return new WaitForEndOfFrame();
                    updateShapeKeyAnalKupaValue(_data);
                }
            }
        }
        void EndClick(string _targetClick)
        {
            if (!bInitCompleted) return;
            _reasonNow = -1;
            switch (_targetClick)
            {
                case "target_vagina":
                    {
                        StopCoroutine("DelayResetKupa");
                        StartCoroutine("DelayResetKupa");
                        break;
                    }
                case "target_hip":
                    {
                        StopCoroutine("DelayResetAnalKupa");
                        StartCoroutine("DelayResetAnalKupa");
                        break;
                    }
            }
        }
        ...
        private IEnumerator initCoroutineNormal(float waitTime)
        {
            yield return new WaitForSeconds(WaitFirstInit);
            int _check = 5;
            bInitCompleted = false;
            // tại đây chỉ nhận thông báo cục bộ
            while (!(bInitCompleted = InitNormal()) && _check-- > 0)
            {
                //Debug.LogWarning("Check init normal");
                yield return new WaitForSeconds(waitTime);
            }
            //Debug.LogWarning("Initialization normal complete.");
        ...
        private IEnumerator initCoroutine(float waitTime)
        {
            yield return new WaitForSeconds(WaitFirstInit);
            bInitCompleted = false;
            //  bInitCompleted = initialize();
            // chỉ có scene này là đủ các thành phần
            
                while (!(bInitCompleted = initialize()))
                {
                    //Debug.LogWarning("Check init");
                    yield return new WaitForSeconds(waitTime);
                }
         

            //Debug.LogWarning("Initialization complete.");
        }
         bool InitNormal()
        {
        ...
        private bool initialize()
        {
            ...
            if(goCommandUnit==null)
            {
                LogWarning("first");
                return false;
            }
            if (!IsActive(this.goCommandUnit))
            {
                LogWarning("1");
                return false;
            }// 夜伽コマンド画面かどうか
            ...
            if (IsNull(this.maidFoceKuchipakuSelfUpdateTime))
            {
                LogWarning("4");
                return false;
            }
            ...
            // 夜伽コマンドフック
            {
                ...
                catch (Exception ex) { LogError("SetCommandCallback() : {0}", ex);
                    {
                        LogWarning("8");
                        return false;
                    }
            ...
            // Face・FaceBlendフック
            {
                ...
                catch (Exception ex) { LogError("kagScriptCallBack() : {0}", ex);
                    {
                        LogWarning("12");
                        return false;
                    }
            ...
            // Window
            {
                ...
                grid["FaceAnime"] = new YotogiButtonGrid("GridButton:FaceAnime", sFaceNames, faceNameShow, this.OnClickButtonFaceAnime, 6, false);
                grid["FaceBlend"] = new YotogiButtonGrid("GridButton:FaceBlend", sFaceNames, faceNameShow, this.OnClickButtonFaceBlend, 6, true);
                    ...
                    else
                    {
                        foreach (AnimationState stat in anm_BO_body001)
                        {
                            if (stat.enabled)
                            {
                                ...
                                //////Debug("{0}:{1}:{2}", stat.name, stat.speed, stat.enabled);
                            }
                        }
                    }
                }
        ...
        private int GetSizeKupa(int[] arr,  int index, int def)
        {
            if(index==1)
            {
                return UnityEngine.Random.Range(def, arr[index]);
            }
            else
            {
                if(index>1)
                    return UnityEngine.Random.Range(arr[index-1], arr[index]);

            }
            return UnityEngine.Random.Range(10, def);
        }
        private void initAnimeOnCommand()
        {
            if (panel["AutoAHE"].Enabled)
            {
                ...
                for (int i = 0; i < 2; i++)
                {
                    if (pa["KUPA.挿入." + i].NowPlaying)
                    {
                        _orriganlKupaSkill = iKupaValue[i];
                        updateShapeKeyKupaValue(iKupaValue[i]);
                    }
                    pa["KUPA.挿入." + i].Stop();
                }
                ...
                for (int i = 0; i < 2; i++)
                {
                    if (pa["AKPA.挿入." + i].NowPlaying)
                    {
                        _orriganlAnalKupaSkill = iAnalKupaValue[i];

                        updateShapeKeyAnalKupaValue(iAnalKupaValue[i]);
                    }
                    pa["AKPA.挿入." + i].Stop();
                }
            }
            ...
            if (panel["AutoKUPA"].Enabled)
            {
                ...
                {
                    _orriganlAnalKupaSkill = iAnalKupaMin;
                    pa["AKPA.止める"].Stop();
        ...
        private void playAnimeOnCommand(Yotogi.SkillData.Command.Data.Basic data)
        {
            ...
            ////Debug("Skill:{0} Command:{1} Type:{2}", data.group_name, data.name, data.command_type);
            ...
            if (panel["AutoKUPA"].Enabled)
            {
                ...
                {
                    _orriganlKupaSkill = iKupaValue[i];
                    if (from < _orriganlKupaSkill)
                        pa["KUPA.挿入." + i].Play(from, _orriganlKupaSkill);
                    bKupaFuck = true;
                }
                ...
                {
                    _orriganlAnalKupaSkill =iAnalKupaValue[i];
                    if (from < _orriganlAnalKupaSkill)
                        pa["AKPA.挿入." + i].Play(from, _orriganlAnalKupaSkill);
                    bAnalKupaFuck = true;
                }
        ...
        //----
        private float getValueSlider(string name)
        {
            return( Container.Find<YotogiSlider>(window, name).Value);
        }
        ...
        private T parseExIni<T>(string section, string key, T def)
        {
            ...
            ////Debug("Ini: [{0}] {1}='{2}'", section, key, res);
            return res;
        }
     ...
     /*   [System.Diagnostics.Conditional("//Debug")]
        ...
        internal static IEnumerator CheckFadeStatus(WfScreenChildren wsc, float waitTime)
        {
            while (true)
            {
                ////Debug(wsc.fade_status.ToString());
                yield return new WaitForSeconds(waitTime);
            }
        }
        ...
        internal static void WriteComponent(GameObject go)
        {
            ...
            foreach (Component c in compos) {
                ////Debug("{0}:{1}", go.name, c.GetType().Name); 
            }
        }
